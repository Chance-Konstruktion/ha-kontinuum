...
> - Module (alle 26): [`kontinuum-core/docs/MODULES.md`](https://gitlab.schanz.ipv64.net/chance-konstruktion/kontinuum-core/-/blob/main/docs/MODULES.md)
> - Pipeline & Snapshot-Felder: [`kontinuum-core/docs/PIPELINE.md`](https://gitlab.schanz.ipv64.net/chance-konstruktion/kontinuum-core/-/blob/main/docs/PIPELINE.md)
